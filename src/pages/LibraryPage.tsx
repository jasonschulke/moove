...
import type { SavedWorkout, WorkoutBlock, Exercise, MuscleArea, EquipmentType } from '../types';
import { loadSavedWorkouts, deleteSavedWorkout, addSavedWorkout, updateSavedWorkout, loadFavorites, toggleFavoriteWorkout, toggleFavoriteExercise, getExerciseDescription, setExerciseDescription, clearExerciseDescription } from '../data/storage';
...
type TabType = 'habits' | 'workouts' | 'exercises' | 'equipment';
